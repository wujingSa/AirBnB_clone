...
class TestBaseModel(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertEqual(str(b),
                         "[BaseModel] ({}) {}".format(b.id, b._dict_))
    ...
    def test_args_unused(self):
        ...
        """
        b = BaseModel(None)
        self.assertNotIn(None, b._dict_.values())
    ...
    def test_if_to_dict_returns_class_dunder_method(self):
        """
        Checks if BaseModel.to_dict() contains _class_
        """
        b = BaseModel()
        self.assertTrue("_class_" in b.to_dict())
    ...
    def test_if_to_dict_returns_the_accurate_number_of_keys(self):
        ...
        """
        b = BaseModel()
        partial_expectation = {k: v for k, v in b._dict_.items()
    ...
    def test_that_to_dict_contains_correct_keys(self):
        ...
        attrs = ("id", "created_at", "updated_at", "_class_")
        for attr in attrs:
    ...
    def test_to_dict_not_dunder_dict(self):
        """Checks that to_dict() is a dict object not equal to _dict_"""
        bm = BaseModel()
